-- Migration 005: Spec v1.1 & RFC §7.4 Updates
...
-- 5. Audit log column for gap linking & event_type type conversion
ALTER TABLE audit_log ALTER COLUMN event_type TYPE TEXT;
